...
$sql="select db1_id from db1 where status='Rejected' unique ";
$sql1="select * from db2 where status='Rejected' ";
                    ...
                    if($data) 
                    {
                     echo "<table class='Requests'>
                        ...
                        echo "<tr>
                                ...
                                echo "<td><a href='admin_request.php?id=" .$row['id']." '>All Requests</a></td>";
                            echo "</tr>";
                            }
                    echo "</table>";
                } 
